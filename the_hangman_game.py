...
def main():
    ...
    while again:
        ...
        # Get random capital, split to list of [capital's letters, dash letters]
        ...
        while lives > 0 and win_condition:
            ...
            check_message = hmfunc.check_if_input_correct(message, list_of_chars)
            if check_message[0]:
            ...
            if hmfunc.check_success(dash_letters, list_of_chars[0]):
                ...
                hmfunc.show_all\
                    (dash_letters, list_wrong_letters, lives, capital[0])
